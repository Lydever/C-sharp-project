...
namespace 抽象类输出职员薪水_7
{
    //programmer
    class Programmer
    {
        public class myProgrammer : Employee, IPromotable
        {
            protected double hours;

            public void Programmer(string name, double salary, double hours)
            {
                this.Name = name;
                this.Salary = salary;
                this.Hours = hours;
    ...
    class Shixi
    {
        public class myShixi : Employee
        {
            private double salary;
            protected int months;
            private string name;

            public void Shixi(string name, double salary, int months)
            {
                this.Name = name;
                this.Salary = salary;
                this.Months = months;
    ...
    class Manager
    {
        ...
        public class myManager : Employee
        {
            public void Manager(string name, double salary, string mishu)
            {
                this.Name = name;
                this.Salary = salary;
                this.Mishu = mishu;
    ...
    class IPromotable
    {
        public interface myIPromotable
        {
            void Promote();
        }
    }
    ...
    class Employee
    {
        public abstract class  myEmployee   //创建Employee类
        {
